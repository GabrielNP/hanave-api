...
INSERT INTO public.products (title,price,description,category,image,size_available,color_available) VALUES
    ...
    ('Camiseta Básica',21.5,'Camiseta Básica Branca Com Mangas Pretas','Camiseta Masculina','https://fakestoreapi.com/img/71-3HjGNDUL._AC_SY879._SX._UX._SY._UY_.jpg','{"S","M","B"}','{"black"}'),
    ...
    ('Bracelete Masculino',30.5,'Bracelete Masculino Em Formato De Dragão','Bracelete Masculino','https://fakestoreapi.com/img/71pWzhdJNwL._AC_UL640_QL65_ML3_.jpg','{"4","5","6"}','{"black"}'),
    ...
    ('Sobretudo Inverno',120.0,'Sobretudo Para o Inverno Lilás','Sobretudo Feminino','https://fakestoreapi.com/img/51Y5NI-I5jL._AC_UX679_.jpg','{"S","M","B"}','{"lilac"}'),
